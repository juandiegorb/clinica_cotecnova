...
<head>
  ...
  <title>Cl&iacute;nica Cotecnova - Eliminar cita</title>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                  <label class="col-sm-12">Ingrese el ID de la cita a borrar</label>
                  </div>         
                 <div class="form-group">
                  <label class="col-sm-12">ID</label>            
                  <div class="col-md-12">
                    <input type="text" placeholder="Ingrese el ID de la cita" class="form-control form-control-line">
                  </div>
                </div>    
                <div class="form-group">
